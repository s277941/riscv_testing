...
\
li x1, 0x00000000;\
pv.srl.sci.h x3, x1, 2;\
sw x3, 4(x31);\
li x1, 0x00000000;\
pv.srl.sci.h x3, x1, 3;\
sw x3, 4(x31);\
li x1, 0x00000000;\
pv.srl.sci.h x3, x1, 4;\
sw x3, 4(x31);\
\
/*PART 13*/\
\
li x1, 0xb6db6db6;\
pv.sra.sci.h x3, x1, 2;\
sw x3, 4(x31);\
li x1, 0xffffffff;\
pv.sll.sci.h x3, x1, 2;\
sw x3, 4(x31);\
li x1, 0x55555555;\
li x2, 0x00000001;\
p.addN x3, x1, x2, 3;\
...
p.adduRN x3, x1, x2, 8;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 10;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 11;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 14;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 19;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 20;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 22;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 27;\
sw x3, 4(x31);\
p.adduRN x3, x1, x2, 29;\
sw x3, 4(x31);\
p.subRN x3, x1, x2, 2;\
sw x3, 4(x31);\
\
...
sw x3, 4(x31);\
li x1, 0xa5a5a5a5;\
pv.sra.sci.h x3, x1, 6;\
sw x3, 4(x31);\
li x1, 0xa5a5a5a5;\
pv.sra.sci.h x3, x1, 8;\
sw x3, 4(x31);\
\
/*PART 19*/\
\
