#define ALU_IMPROVED() \
TEST_ALU_imm(0xA5A5A5A5, 0x3C3C3C3C);\
TEST_ALU_imm(0xA5A5A5A5, 0xA5A5A5A5);\
TEST_ALU_imm(0x3C3C3C3C, 0x3C3C3C3C);\
TEST_ALU_imm(0x3C3C3C3C, 0xA5A5A5A5);\
TEST_ALU_imm(0xA5A5A5A5, 0xFFFFFFFF);\
TEST_ALU_imm(0xFFFFFFFF, 0x3C3C3C3C);\
\
